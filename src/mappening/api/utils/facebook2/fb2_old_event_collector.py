...
accessToken = 'EAAFB1Et4EnkBAA7U1Wdhz90TdbU3UTkFOWz1iaNo0ZBB3BawALuyFxKpB1SEZBeZBrQtRbUr4NCgwnZBAgmuQgZCJkSZBxZAReBo8yNZBhsFmGJrpWQpBSdJB4uQr4pE2F0PV5IeQvfjH7jy5h478lhqTcYhBCJMGnzZCGqFILcAxIQZDZD'
...
def get_raw_events():
    ...
    place_search_args = {
        ...
        # 'distance': '1000',
        # 'limit': '100',
        'fields': "events{category,cover,description,start_time,is_canceled,name,owner,updated_time,id,place,maybe_count,noreply_count,interested_count,attending_count,end_time}",
    ...
    # TODO: inject cover images into the json before return
    # also make sure that the zip code is updated in the json to return
