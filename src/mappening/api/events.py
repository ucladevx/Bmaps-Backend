...
from mappening.utils.database import events_internal_added_collection, events_current_processed_collection
...
def get_all_events():
    ...
    """
    return event_collector.find_events_in_database(print_results=False)
...
def get_fb_events():
  ...
  """
  fb_events = fb_event_collector.get_interested_events()
  fb_events_cleaned = fb_event_processor.process_events(fb_events)
