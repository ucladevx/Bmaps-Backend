"""
event_caller - process and interpret events
"""
...
def get_event_time_bounds():
    """
    Get event time bounds in formatted form
    """
...
def entity_in_right_location(loc_data):
    """
    Check if entity is in correct/valid location
...
def find_ucla_entities(app_access_token):
    """
    For searching both place and page for UCLA entities
    """
    ucla_entities = {}
    page_search_args = {
        'type': 'page',
